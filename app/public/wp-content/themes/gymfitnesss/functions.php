...
// Menus de navegación, agregar más utilizando el arreglo
    function gymfitness_menus(){
        register_nav_menus(array(
            ...
            'menu-principal2' => __( 'Menu Principal 2', 'gymfitness' )
        ));
    }
    ...
    function gymfitness_scripts_styles(){
        ...
        if(is_page('inicio')):
            wp_enqueue_script('bxSliderCSS','https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.min.js', array('jquery'), '4.2.12', true);
       endif;

        if(is_page('contacto')):
            wp_enqueue_script('leaftetJS','https://unpkg.com/leaflet@1.5.1/dist/leaflet.js', array('jquery'), '1.5.1', true);
       endif;
        // Script de slicknav
